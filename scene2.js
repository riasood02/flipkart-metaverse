...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.load('assets/mremireh_o_desbiens.fbx', (fbx) => {
      ...
      loader.load('assets/idle.fbx', (a) => { _OnLoad('idle', a); });
      loader.load('assets/dance.fbx', (a) => { _OnLoad('dance', a); });
    });
  }
...
class ThirdPersonCameraDemo {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
        ...
        './assets/lawn/posy.jpg',
        './assets/lawn/negy.jpg',
        './assets/lawn/posz.jpg',
        './assets/lawn/negz.jpg',
    ]);
